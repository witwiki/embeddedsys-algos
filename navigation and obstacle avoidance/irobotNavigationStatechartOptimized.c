...
#define RAD_TO_DEG			(180.0 / M_PI)		// degrees per radian
#define DEG_TO_RAD			(M_PI / 180.0)		// radians per degree
...
void irobotNavigationStatechart(
	...
	/******************************************************/
	//_sleep(0.00000001);										//	Help control simulation time.
